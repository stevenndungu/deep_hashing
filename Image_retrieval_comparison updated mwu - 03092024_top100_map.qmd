...
dt_valid  = pd.read_csv(f"final paper results/merged_validation_runs_wide_format_abs_30082024_top100_{layer_vsn}.csv")


dt_test  = pd.read_csv(f"final paper results/merged_test_runs_wide_format_abs_30082024_top100_{layer_vsn}.csv")
...
res_valid_mwu_80 = res.T.sort_values(by=['mean'], ascending= False)

html_table = res_valid_mwu_80.to_html(index=True)
...
res_test_mwu_80 = res.T.sort_values(by=['mean'], ascending= False)

html_table = res_test_mwu_80.to_html(index=True)
...
res_valid_mwu_80['id'] = res_valid_mwu_80.index.to_series().apply(extract_number)
res_test_mwu_80['id'] = res_test_mwu_80.index.to_series().apply(extract_number)

res_comb = pd.concat([res_valid_mwu_80,res_test_mwu_80])
index_series = res_comb.index.to_series()
...
res_test_mwu_80 = res_test_mwu_80.sort_values(by=['id']).reset_index().query("index !='average_map'")


res_valid_mwu_80 =  res_valid_mwu_80.reset_index(drop=True)
res_valid_mwu_80.columns = ['valid_score', 'std', 'id']
res_valid_mwu_80 = res_valid_mwu_80[['valid_score', 'id']]

res_test_mwu_80.columns = ['label2', 'test_score', 'std', 'id']
res_test_mwu_80 = res_test_mwu_80[['test_score', 'id']]


result_merged_mwu_80 = pd.merge(res_valid_mwu_80,res_test_mwu_80,on='id')


result_merged_mwu_80.sort_values(by=['valid_score'], ascending=False,inplace=True)

result_merged_mwu_80 = result_merged_mwu_80[['id','valid_score','test_score']]

html_table = result_merged_mwu_80.to_html(index=True)
...
res_valid_mwu_88 = res.T.sort_values(by=['mean'], ascending= False)

html_table = res_valid_mwu_88.to_html(index=True)
...
res_test_mwu_88 = res.T.sort_values(by=['mean'], ascending= False)

html_table = res_test_mwu_88.to_html(index=True)
...
res_valid_mwu_88['id'] = res_valid_mwu_88.index.to_series().apply(extract_number)
res_test_mwu_88['id'] = res_test_mwu_88.index.to_series().apply(extract_number)

res_comb = pd.concat([res_valid_mwu_88,res_test_mwu_88])
index_series = res_comb.index.to_series()
...
res_test_mwu_88 = res_test_mwu_88.sort_values(by=['id']).reset_index().query("index !='average_map'")


res_valid_mwu_88 =  res_valid_mwu_88.reset_index(drop=True)
res_valid_mwu_88.columns = ['valid_score', 'std', 'id']
res_valid_mwu_88 = res_valid_mwu_88[['valid_score', 'id']]

res_test_mwu_88.columns = ['label2', 'test_score', 'std', 'id']
res_test_mwu_88 = res_test_mwu_88[['test_score', 'id']]


result_merged_mwu_88 = pd.merge(res_valid_mwu_88,res_test_mwu_88,on='id')


result_merged_mwu_88.sort_values(by=['valid_score'], ascending=False,inplace=True)

result_merged_mwu_88 = result_merged_mwu_88[['id','valid_score','test_score']]

html_table = result_merged_mwu_88.to_html(index=True)
...
res_valid_mwu_96 = res.T.sort_values(by=['mean'], ascending= False)

html_table = res_valid_mwu_96.to_html(index=True)
...
res_test_mwu_96 = res.T.sort_values(by=['mean'], ascending= False)

html_table = res_test_mwu_96.to_html(index=True)
...
res_valid_mwu_96['id'] = res_valid_mwu_96.index.to_series().apply(extract_number)
res_test_mwu_96['id'] = res_test_mwu_96.index.to_series().apply(extract_number)

res_comb = pd.concat([res_valid_mwu_96,res_test_mwu_96])
index_series = res_comb.index.to_series()
...
res_test_mwu_96 = res_test_mwu_96.sort_values(by=['id']).reset_index().query("index !='average_map'")


res_valid_mwu_96 =  res_valid_mwu_96.reset_index(drop=True)
res_valid_mwu_96.columns = ['valid_score', 'std', 'id']
res_valid_mwu_96 = res_valid_mwu_96[['valid_score', 'id']]

res_test_mwu_96.columns = ['label2', 'test_score', 'std', 'id']
res_test_mwu_96 = res_test_mwu_96[['test_score', 'id']]


result_merged_mwu_96 = pd.merge(res_valid_mwu_96,res_test_mwu_96,on='id')


result_merged_mwu_96.sort_values(by=['valid_score'], ascending=False,inplace=True)

result_merged_mwu_96 = result_merged_mwu_96[['id','valid_score','test_score']]

html_table = result_merged_mwu_96.to_html(index=True)
...
res_valid_mwu_128 = res.T.sort_values(by=['mean'], ascending= False)

html_table = res_valid_mwu_128.to_html(index=True)
...
optimal_params.to_csv('optimal_params_128bit.csv',index=False)
#rotation invariance test data with optimal parameters
test_data_1 = pd.merge(optimal_params, dt_test, how='left')
test_data_1_sub = test_data_1[list(test_data_1.columns[test_data_1.columns.str.startswith('mAP_test')])]
test_data_1['average_map'] = test_data_1_sub.apply(np.mean, axis=1)
...
res_test_mwu_128 = res.T.sort_values(by=['mean'], ascending= False)

html_table = res_test_mwu_128.to_html(index=True)
...
res_valid_mwu_128['id'] = res_valid_mwu_128.index.to_series().apply(extract_number)
res_test_mwu_128['id'] = res_test_mwu_128.index.to_series().apply(extract_number)

res_comb = pd.concat([res_valid_mwu_128,res_test_mwu_128])
index_series = res_comb.index.to_series()
...
res_test_mwu_128 = res_test_mwu_128.sort_values(by=['id']).reset_index().query("index !='average_map'")


res_valid_mwu_128 =  res_valid_mwu_128.reset_index(drop=True)
res_valid_mwu_128.columns = ['valid_score', 'std', 'id']
res_valid_mwu_128 = res_valid_mwu_128[['valid_score', 'id']]

res_test_mwu_128.columns = ['label2', 'test_score', 'std', 'id']
res_test_mwu_128 = res_test_mwu_128[['test_score', 'id']]


result_merged_mwu_128 = pd.merge(res_valid_mwu_128,res_test_mwu_128,on='id')


result_merged_mwu_128.sort_values(by=['valid_score'], ascending=False,inplace=True)

result_merged_mwu_128 = result_merged_mwu_128[['id','valid_score','test_score']]

html_table = result_merged_mwu_128.to_html(index=True)
...
result_merged_mwu_80_best = result_merged_mwu_80.describe().iloc[1:2].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_80_best['bit'] = 80

result_merged_mwu_88_best = result_merged_mwu_88.describe().iloc[1:2].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_88_best['bit'] = 88

result_merged_mwu_96_best = result_merged_mwu_96.describe().iloc[1:2].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_96_best['bit'] = 96

result_merged_mwu_104_best = result_merged_mwu_104.describe().iloc[1:2].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_104_best['bit'] = 104

result_merged_mwu_128_best = result_merged_mwu_128.describe().iloc[1:2].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_128_best['bit'] = 128

result_merged_mwu_best = pd.concat([result_merged_mwu_16_best,result_merged_mwu_24_best,result_merged_mwu_32_best,result_merged_mwu_40_best,result_merged_mwu_48_best,result_merged_mwu_56_best,result_merged_mwu_64_best,result_merged_mwu_72_best,result_merged_mwu_80_best,result_merged_mwu_88_best,result_merged_mwu_96_best,result_merged_mwu_104_best,result_merged_mwu_128_best])
...
result_merged_mwu_80_std = result_merged_mwu_80.describe().iloc[2:3].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_80_std['bit'] = 80

result_merged_mwu_88_std = result_merged_mwu_88.describe().iloc[2:3].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_88_std['bit'] = 88

result_merged_mwu_96_std = result_merged_mwu_96.describe().iloc[2:3].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_96_std['bit'] = 96

result_merged_mwu_104_std = result_merged_mwu_104.describe().iloc[2:3].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_104_std['bit'] = 104

result_merged_mwu_128_std = result_merged_mwu_128.describe().iloc[2:3].reset_index()[['valid_score', 'test_score']]
result_merged_mwu_128_std['bit'] = 128

result_merged_mwu_std = pd.concat([result_merged_mwu_16_std,result_merged_mwu_24_std,result_merged_mwu_32_std,result_merged_mwu_40_std,result_merged_mwu_48_std,result_merged_mwu_56_std,result_merged_mwu_64_std,result_merged_mwu_72_std,result_merged_mwu_80_std,result_merged_mwu_88_std,result_merged_mwu_96_std,result_merged_mwu_104_std,result_merged_mwu_128_std])
...
df_report = df[['bit','valid_score', 'test_score',  'valid_score_std',     'test_score_std']]
...
# # Show the plot
# plt.tight_layout()
# plt.savefig('paper images/valid_test1.svg',format='svg', dpi=1200)
# plt.show()
