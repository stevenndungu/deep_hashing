...
dt_valid  = pd.read_csv(f"descriptors_v2/merged_validation_runs_wide_format_abs_13062024_{layer_vsn}.csv")


dt_test  = pd.read_csv(f"descriptors_v2/merged_test_runs_wide_format_abs_13062024_{layer_vsn}.csv")
...
#%%
dt_valid  = pd.read_csv(f"descriptors_v2/merged_validation_runs_wide_format_zero_13062024_{layer_vsn}.csv")


dt_test  = pd.read_csv(f"descriptors_v2/merged_test_runs_wide_format_zero_13062024_{layer_vsn}.csv")
...
res1_valid = res.T.sort_values(by=['mean'], ascending= False)

html_table = res1_valid.to_html(index=True)
...
res1_test = res.T.sort_values(by=['mean'], ascending= False)

html_table = res1_test.to_html(index=True)
...
res2_valid = res.T.sort_values(by=['mean'], ascending= False)

html_table = res2_valid.to_html(index=True)
...
res2_test = res.T.sort_values(by=['mean'], ascending= False)

html_table = res2_test.to_html(index=True)
