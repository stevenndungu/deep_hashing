...
#df_optimal_params = pd.read_csv('optimal_params_72bit.csv')
epoch_values = [2000]
                        ...
                        for bitsize in bitsize_values:
                            for l1_reg in l1_reg_values:
                                for l2_reg in l2_reg_values:  
                                    ...
                                    if not os.path.isfile(output_dir + "/model_selection_train_valid_and_test_17092024_top100_v3_layers.csv"):
                                        ...
                                        results_df.to_csv(output_dir + "/model_selection_train_valid_and_test_17092024_top100_v3_layers.csv", index=False)
                                    else:
                                        df = pd.read_csv(output_dir + "/model_selection_train_valid_and_test_17092024_top100_v3_layers.csv")
